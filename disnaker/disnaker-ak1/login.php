    ...
    <div class="nav-content">
        <nav class="nav">
            ...
            <a href="login.php" class="nav-item active">
                <i class="fas fa-sign-in-alt"></i> Login User
            </a>
...
<div class="main-content">
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-title">Login ke MAESAAN</div>
        </div>
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
            <div class="user-info">
                ...
                <p class="mb-3">Nama: <strong><?= $_SESSION['user_name'] ?></strong></p>
                <p class="mb-3">Email: <strong><?= $_SESSION['user_email'] ?></strong></p>
        ...
        <?php else: ?>
            ...
            <div class="text-center mt-4 pt-3 border-top">
                <small class="text-muted">
                    ...
                    Login admin? Gunakan akses khusus admin
                </small>
            </div>
        <?php endif; ?>
    </div>
